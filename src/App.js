...
class App extends Component {
  ...
  toggleRented = (movieId) => {
    ...
    currentMovies.find((m) => m.id === movieId).isRented = !currentMovies.find((m) => m.id === movieId).isRented;
    this.setState({
      ...
      <Router>
        <div className="App">
          ...
          <Route
            path="/catalog"
            exact
            render={() => <Catalog movies={state.movies}  toggleRented={this.toggleRented}/>}
          />
          <Route
            path="/movies/:id"
            exact
            render={(match) => <MovieDetail match={match} movies={state.movies} />}
          />
        </div>
